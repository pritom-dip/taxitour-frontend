                    ...
                    <div className="row">
                        ...
                        <div className="col-md-6">
                            <div className="mb-3">
                                ...
                                <input {...register("arrival_time", { required: true })} type="time" name="arrival_time" className="form-control" placeholder="Arrival Time" />
                                {errors.arrival_time && <span className="text-danger">Please select arrival time</span>}
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="row">
                        <div className="col-md-6">
                            <div className="mb-3">
                                ...
                                <input {...register("flight_no", { required: true })} type="text" name="flight_no" className="form-control" placeholder="Flight No" />
                                {errors.flight_no && <span className="text-danger">Flight No is required</span>}
                            </div>
                        </div>
                        <div className="col-md-6">
                            <div className="mb-3">
                                ...
                                <input {...register("no_of_persons", { required: true })} type="text" name="no_of_persons" className="form-control" placeholder="Nr. of persons" />
                                {errors.no_of_persons && <span className="text-danger">Last Name is required</span>}
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="row">
                        ...
                        <div className="col-md-6">
                            <div className="mb-3">
                                ...
                                <input {...register("lname", { required: true })} type="text" name="lname" className="form-control" placeholder="Last Name" />
